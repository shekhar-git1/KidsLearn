...
class FruitFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var fruits = arrayOf("Apple", "Banana", "Grapes", "Strawberry", "Pineapple", "Orange", "Mango", "Papaya", "Guava", "WaterMelon" )
        ...
        var intent = Intent(v.context, FruitDetailsActivity::class.java)
